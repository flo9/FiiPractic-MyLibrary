...
namespace BookServiceClient
{
    public class BookService : IBookService
    {
        ...
        {
            var bookUrl = String.Format("book/?title={0}&genre={1}", filterByTitle, bookGenre);
        ...
        {
            var bookUrl = String.Format("book/Genres");
        ...
        {
            var bookUrl = String.Format("book/");
            bool rep = false;
        ...
        public bool Lend(Lending lending)
        {
            var lendUrl = String.Format("lending/");
            bool rep = false;
            using (var response = client
                  .PostAsJsonAsync(lendUrl, lending)
                  .Result)
            {
                rep = response.IsSuccessStatusCode;
            }
